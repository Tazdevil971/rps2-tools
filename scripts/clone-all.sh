...
LLVM_BRANCH="tazdevil971/dev-r5900"
RUST_URL="git@github.com:Tazdevil971/rust.git"
RUST_BRANCH="tazdevil971/dev-r5900"
...
[ ! -d $ROOT/repos/rust ] && git clone -b $RUST_BRANCH $RUST_URL $ROOT/repos/rust